...
function Calendar({}: Props) {
  ...
  return (
    <div className="w-full mb-12">
      <div className="lg:max-[2000px]:hidden flex items-center justify-center gap-4 mb-6">
        <div className="flex items-center mb-4">
          <div className="w-2 h-2 bg-blue-500 rounded-full"></div>{" "}
          <p className="px-3 text-sm md:text-md">Assignment Deadlines</p>
        </div>
        <div className="flex items-center mb-4">
          <div className="w-2 h-2 bg-yellow-500 rounded-full"></div>{" "}
          <p className="px-3 text-sm md:text-md">Lab Schedules</p>
        </div>
        <div className="flex items-center mb-4">
          <div className="w-2 h-2 bg-pink-500 rounded-full"></div>{" "}
          <p className="px-3 text-sm md:text-md">Other Deadlines</p>
        </div>
      </div>
      <div className="grid grid-cols-6">
        <div className="flex items-center col-span-2 mb-4">
          <div className="flex items-center justify-center h-10 border border-black rounded-md w-[12rem] border-1 mx-auto">
            Dates
          </div>
        </div>
      ...
      <div className="grid grid-cols-6 gap-1 sm:gap-2 md:gap-4 max-w-[1224px]">
        {weeks.map((val, i) => (
          <>
            <div className="flex items-center h-8 text-sm bg-gray-200 border border-gray-300 rounded-md border-1 md:text-md">
